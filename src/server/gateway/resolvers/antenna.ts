...
import { Iotube } from "../erc20/contract"
import { ConinPriceResponse } from "../coingeco"
import DB from "../../db";
...
export interface ICtx {
  gateways: {
    antenna: RpcMethod;
    iotube: Iotube;
    coingecko: { fetchCoinPrice: (ids: string, vsCurrencies: string) => Promise<ConinPriceResponse> };
    sql: DB;
  };
}
